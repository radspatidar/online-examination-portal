...
<body>
  ...
  <section class="welcome-area">
    <div class="header-text">
	 ...
	 <p>
	  Welcome to the quiz section! Here, you can attempt quizzes based on topics you've explored.<br>
	  Challenge yourself, apply what you've learned, and see how much you know.<br>
	  It's a fun and interactive way to reinforce your understanding and track your progress.
	</p>
    </div>
  </section>
