...
<head>
  ...
  <title>Admin Dashboard | Acadisia</title>
...
<body>
  ...
  <section class="welcome-area">
    <div class="header-text">
      <h1>Welcome, Admin</h1>
      <p>Manage your users, quizzes, and settings all in one place.</p>
    </div>
  </section>
                     ...
                     <div class="row ">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                            <div class="features-small-item">
                                ...
                                <a href="SubjectServlet?link=quiz"><b>Quiz</b></a>  
                            </div>
                        </div>
                        <!-- ***** Features Small Item End ***** -->
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                            <div class="features-small-item">
                                ...
                                <a href="ReportServlet"><b>Report</b></a>  
                            </div>
                        </div>
                        <!-- ***** Features Small Item End ***** -->
                    </div>
