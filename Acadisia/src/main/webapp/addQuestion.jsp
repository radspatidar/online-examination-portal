        ...
        <div class="header-text">
            <div class="container">
                <div class="row">
					...
					%>
					<h3>Add Questions in Existing Question Bank</h3>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="features-small-item">
                            	<form action="AddQuestionServlet" method="post">
								     <div id="text-left" class="question-line mb-2 text-start">
										<h2 class="text-center" style="color: #8a15ff; font-size: 35px"><b>Add Question</b></h2><br>
								         <div class="mb-3">
					        			 	<textarea name="question_text" class="form-control" style="height: 80px;" oninput="autoResize(this)" placeholder="Enter Question" required></textarea><br>
											<textarea name="answer" class="form-control" style="height: 100px;" oninput="autoResize(this)" placeholder="Enter Answer" required></textarea>
